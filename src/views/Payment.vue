            ...
            <v-row justify-sm="center">
                <v-col cols="12" sm="6">
                    <!-- <v-card  color="#ffff"> -->
                        ...
                        <v-list>
                            <v-card-subtitle  style="font-weight: bold; color:#00E676">Hello,  Lasisi John Hollywood </v-card-subtitle>
                        ...
                        <v-text-field class="ma-1" outlined value="101, Ikoyi Street" label=" Enter Delivery Address Here" readonly="" append-icon="far fa-check-circle" ></v-text-field>
                            <v-card-subtitle class="" style="color:#00E676;">BILLING</v-card-subtitle>
            ...
            <v-row justify="center">
                <v-dialog v-model="dialog" persistent max-width="450">
                    <template v-slot:activator="{ on, attrs }">    
                        <v-col cols="10" sm="6">
                            <v-btn block large="" v-bind="attrs" v-on="on" color="#00E676" class=" text-capitalize white--text justify-center">Make Payment</v-btn>
                        </v-col>
                    </template>
                    <v-card>
                        <v-card-title style="color:#00E676;" >Choose Payment Method</v-card-title>
                        ...
                        <v-card-subtitle style="color:#00E676;"> Delivery info : </v-card-subtitle>
                        <v-card-subtitle style="color:#00E676;"> Name : Lasisi John Hollywood | Address 101, Ikoyi Street  Ikoyi. Post Office Bus Stop. </v-card-subtitle>
                    </v-card>
                </v-dialog>
            </v-row>
       </v-container>
